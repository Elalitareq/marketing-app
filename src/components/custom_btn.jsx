...
const CustomBtn = ({ route, name }) => {
	return (
		<Link
			className="block max-w-[150px] z-40 overflow-hidden relative text-white px-5 py-2 rounded-xl mt-4   bg-blue-600 hover:text-blue-950 border-2 border-blue-600 shadow-md
